...
void mainImage(out vec4 o, vec2 C) {
  ...
  float iterations = iResolution.x < 768.0 ? 30.0 : 60.0;
...
export const Plasma = ({
  ...
  useEffect(() => {
    ...
    // Store uniform refs for external updates
    ...
    const handleMouseMove = e => {
      ...
      uniforms.uMouse.value[0] = mousePos.current.x;
      uniforms.uMouse.value[1] = mousePos.current.y;
    };
    ...
    const loop = t => {
      ...
      if (uniforms.uScale.value !== scale) uniforms.uScale.value = scale;
      if (uniforms.uSpeed.value !== speed * 0.4) uniforms.uSpeed.value = speed * 0.4;
      
      const targetRgb = hexToRgb(color);
      if (uniforms.uCustomColor.value[0] !== targetRgb[0] ||
          uniforms.uCustomColor.value[1] !== targetRgb[1] ||
          uniforms.uCustomColor.value[2] !== targetRgb[2]) {
        uniforms.uCustomColor.value[0] = targetRgb[0];
        uniforms.uCustomColor.value[1] = targetRgb[1];
        uniforms.uCustomColor.value[2] = targetRgb[2];
      }
