...
/* ── Shared branding panel content (rendered twice in the track) ── */
  ...
  return (
    <div className="branding-inner">
      ...
      <p className="auth-brand-subtitle">
        Monitor pollution levels, get health advisories, and stay informed about the air you breathe.
      </p>
      ...
      <div className="auth-stat-row">
        <div className="auth-stat">
          <div className="auth-stat-val">52+</div>
          <div className="auth-stat-lbl">Cities</div>
        </div>
        <div className="auth-stat">
          <div className="auth-stat-val">24/7</div>
          <div className="auth-stat-lbl">Monitoring</div>
        </div>
        <div className="auth-stat">
          <div className="auth-stat-val">AI</div>
          <div className="auth-stat-lbl">Forecasts</div>
        </div>
      </div>
    ...
    <div className="auth-page">
      ...
      <div className="auth-container">
        <div className="auth-split-card">
          ...
          {/* ──────────────────────────────────────────
              CENTERED TOGGLE — fixed above the track
              ────────────────────────────────────────── */}
          <div className="auth-toggle-strip">
            <div className="auth-toggle-pill">
              <div className={[
                'toggle-indicator',
                isSignup ? 'right' : 'left',
                isSwitching ? `switching switch-${switchDir}` : '',
              ].filter(Boolean).join(' ')} />
          ...
          {/* ──────────────────────────────────────────
              SLIDING TRACK
              Both screens live in the DOM always.
              CSS translateX slides between them —
              no unmount/mount = smooth animation.
              ────────────────────────────────────────── */}
          <div className={`auth-track${isSignup ? ' show-signup' : ' show-login'}`}>

            {/* ═══ SCREEN 1 — Login: [Form | Branding] ═══ */}
              ...
              <div className="auth-form-col">
                <div className="panel-inner">
                  ...
                  <form className="auth-form" onSubmit={handleLogin}>
                    ...
                    {loginError && (
                      <div className="error-message">
                        <i className="fa fa-exclamation-circle" /> {loginError}
                      </div>
                    )}
                  ...
                  <p className="auth-link">
                    ...
                    <a href="#" onClick={e => { e.preventDefault(); switchTab('signup') }}>Sign up free</a>
                  </p>
                </div>
              </div>
            ...
            <div className="auth-screen">
              ...
              <div className="auth-form-col">
                <div className="panel-inner">
                  <div className="auth-panel-header">
                    <div className="panel-icon-ring signup-icon">
                      <i className="fa fa-user-plus" />
                    </div>
                  ...
                  <form className="auth-form" onSubmit={handleRegister}>
                    <div className="form-group">
                      ...
                      {regErrors.name && <span className="error-message"><i className="fa fa-exclamation-circle" /> {regErrors.name}</span>}
                    </div>
                    <div className="form-group">
                      <label><i className="fa fa-envelope" /> Email</label>
                      <div className="input-icon-wrap">
                      ...
                      {regErrors.email && <span className="error-message"><i className="fa fa-exclamation-circle" /> {regErrors.email}</span>}
                    </div>
                    <div className="form-row">
                      <div className="form-group">
                        ...
                        <div className="input-icon-wrap">
                          ...
                          <button type="button" className="pwd-toggle" onClick={() => setShowRegPwd(v => !v)} tabIndex="-1">
                            <i className={`fa ${showRegPwd ? 'fa-eye-slash' : 'fa-eye'}`} />
                          </button>
                        </div>
                      ...
                      <div className="form-group">
                        ...
                        <div className="input-icon-wrap">
                          ...
                          <button type="button" className="pwd-toggle" onClick={() => setShowRegConfirmPwd(v => !v)} tabIndex="-1">
                            <i className={`fa ${showRegConfirmPwd ? 'fa-eye-slash' : 'fa-eye'}`} />
                          </button>
                        </div>
                  ...
                  <p className="auth-link">
                    ...
                    <a href="#" onClick={e => { e.preventDefault(); switchTab('login') }}>Log in</a>
                  </p>
                </div>
              </div>
            </div>
